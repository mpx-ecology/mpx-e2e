...
var e2eMockStatic = function (dirname) {
    return function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
        var url, urlWithoutQueryFirstSlash, fileName, absDirname, filePath, statObj, _a, e_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    url = ctx.request.url;
                    urlWithoutQueryFirstSlash = utils.urlWithoutQuery(url).slice(1);
                    fileName = utils.toDashJoin(urlWithoutQueryFirstSlash);
                    absDirname = path.resolve(dirname);
                ...
                case 2:
                    statObj = _b.sent();
                    if (!statObj.isFile()) return [3 /*break*/, 4];
                    _a = ctx;
