...
var https_helper_1 = __importDefault(require("./https-helper"));
// const httpRequest = require('./https-helper');
var urlGenerator = function (u, p) {
    if (p === void 0) { p = 'https://'; }
    return p + u;
};
function proxyMiddleware(mockMap) {
    ...
    return function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
        var request, method, url, header, originHost, urlWithoutQuery, res, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    request = ctx.request;
                    method = request.method, url = request.url, header = request.header;
                    originHost = header.mpx_origin_host;
                    urlWithoutQuery = url.slice(0, url.indexOf('?'));
                    if (!mockMap.has(originHost + urlWithoutQuery)) return [3 /*break*/, 1];
                ...
                case 1:
                    ...
                    return [4 /*yield*/, https_helper_1.default(urlGenerator(originHost + url), header, request.body, method)];
                case 2:
                    res = _a.sent();
